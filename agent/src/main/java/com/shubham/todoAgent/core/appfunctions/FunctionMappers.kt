package com.shubham.todoAgent.core.appfunctions
...
private fun AppFunctionMetadata.toFunctionDeclaration(): FunctionDeclaration =
    FunctionDeclaration(
        ...
        description = this.description.ifBlank { this.id.substringAfterLast("#").humanizeIdentifier() },
...
private fun createObjectSchema(
    ...
    Schema(
        ...
        properties = params.associate { param ->
            ...
            param.name to baseSchema.copy(
                description = param.description.ifBlank { param.name.humanizeIdentifier() }
            )
        },
